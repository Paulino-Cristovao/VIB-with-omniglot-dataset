...
def load_torch_data(k_shot, base_class):
    # mnist
    df_train_mnist = pd.read_csv('/content/drive/MyDrive/code/data/train.csv')
    ...
    novel_loader = torch.utils.data.DataLoader(novel, batch_size=batch_size, shuffle=False)

    return test_loader, novel_loader
